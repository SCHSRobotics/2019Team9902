...
@Autonomous(name="Move Base and Go to Center, from Top Left (Blue)", group="Blue")

public class BaseAndCenterBlueTop extends LinearOpMode {
    MecanumEncoders mE;
    ArmDriver gA;
    ...
    public void runOpMode() {
        ...
        mE.mecanumEncoders(5, 0, 0, false);
        mE.mecanumEncoders(-5, 0, 0, false);
        mE.mecanumEncoders(0, -10, 0, true);
        sleep(5000);
